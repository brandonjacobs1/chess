...
public class ApiCall {
    ...
    public <T> T makeRequest(String method, String path, Object request, Type responseClass, AuthData auth) throws ResponseException {
        try {
    ...
    public static <T> T readBody(HttpURLConnection http, Type responseClass) throws IOException {
        T response = null;
